    ...
    <table class="min-w-full border-collapse border border-grey-400 mt-4">
        <thead>
            <tr class="text-left bg-grey-100">
                ...
                <th class="py-2 px-4 border border-blue-300">Kode</th>
                <th class="py-2 px-4 border border-blue-300">Nama</th>
                <th class="py-2 px-4 border border-blue-300">Status</th>
        ...
        <tbody>
            @foreach ($ruangs as $ruang)
                <tr>
                    <td class="py-2 px-4 border border-blue-300">{{ $ruang->id }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $ruang->kode }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $ruang->nama }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $ruang->status }}</td>
