    ...
    <table class="min-w-full border-collapse border border-grey-400 mt-4">
        <thead>
            <tr class="text-left bg-grey-100">
                <th class="py-2 px-4 border border-blue-300">No</th>
                <th class="py-2 px-4 border border-blue-300">NIP</th>
                <th class="py-2 px-4 border border-blue-300">Nama</th>
                <th class="py-2 px-4 border border-blue-300">Unit Kerja</th>
        ...
        <tbody>4index 
            @foreach ($pegawais as $index => $pegawai)
                <tr>
                    <td class="py-2 px-4 border border-blue-300">{{ $index + 1 }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $pegawai->nip }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $pegawai->nama }}</td>
                    <td class="py-2 px-4 border border-blue-300">{{ $pegawai->nama_unit_kerja }}</td>
